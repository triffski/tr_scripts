...
# Scripts & Batch Files
Right now just a couple of Python scripts for managing photos and other data exported from Google and Meta platforms. My use case is photos to Immich, timeline data to Darawich, Saved Places to OsmAnd.
